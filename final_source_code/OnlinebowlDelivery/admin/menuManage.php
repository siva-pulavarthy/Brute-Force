						...
						<table class="table table-bordered table-hover mb-0">
                            ...
                            <?php
                                ...
                                while($row = mysqli_fetch_assoc($result)){
                                    ...
                                    echo '<tr>
                                            <td class="text-center">' .$bowlCategorieId. '</td>
                                            <td>
                                            ...
                                            <td class="text-center">
												<div class="row mx-auto" style="width:112px">
													<button class="btn btn-sm btn-primary" type="button" data-toggle="modal" data-target="#updateItem' .$bowlId. '">Edit</button>
...
<?php 
    $bowlsql = "SELECT * FROM `bowl`";
    $bowlResult = mysqli_query($conn, $bowlsql);
    while($bowlRow = mysqli_fetch_assoc($bowlResult)){
        $bowlId = $bowlRow['bowlId'];
        $bowlName = $bowlRow['bowlName'];
        $bowlPrice = $bowlRow['bowlPrice'];
        $bowlCategorieId = $bowlRow['bowlCategorieId'];
        $bowlDesc = $bowlRow['bowlDesc'];
?>

<!-- Modal -->
<div class="modal fade" id="updateItem<?php echo $bowlId; ?>" tabindex="-1" role="dialog" aria-labelledby="updateItem<?php echo $bowlId; ?>" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: rgb(111 202 203);">
        <h5 class="modal-title" id="updateItem<?php echo $bowlId; ?>">Item Id: <?php echo $bowlId; ?></h5>
	  	...
	  	<form action="partials/_menuManage.php" method="post" enctype="multipart/form-data">
		    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
				...
				<div class="form-group col-md-4">
					<img src="/OnlinebowlDelivery/img/bowl-<?php echo $bowlId; ?>.jpg" id="itemPhoto" name="itemPhoto" alt="item image" width="100" height="100">
				</div>
			</div>
		</form>
		<form action="partials/_menuManage.php" method="post">
